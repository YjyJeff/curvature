...
pub unsafe fn eq_scalar<T>(
    ...
    u64: AsPrimitive<<T::SimdType as IntrinsicSimdOrd>::BitMaskType>,
{
    cmp_scalar(selection, array, scalar, dst, eq_scalar_dynamic)
}
...
pub unsafe fn ne_scalar<T>(
    ...
    u64: AsPrimitive<<T::SimdType as IntrinsicSimdOrd>::BitMaskType>,
{
    cmp_scalar(selection, array, scalar, dst, ne_scalar_dynamic)
}
...
pub unsafe fn gt_scalar<T>(
    ...
    u64: AsPrimitive<<T::SimdType as IntrinsicSimdOrd>::BitMaskType>,
{
    cmp_scalar(selection, array, scalar, dst, gt_scalar_dynamic)
}
...
pub unsafe fn ge_scalar<T>(
    ...
    u64: AsPrimitive<<T::SimdType as IntrinsicSimdOrd>::BitMaskType>,
{
    cmp_scalar(selection, array, scalar, dst, ge_scalar_dynamic)
}
...
pub unsafe fn lt_scalar<T>(
    ...
    u64: AsPrimitive<<T::SimdType as IntrinsicSimdOrd>::BitMaskType>,
{
    cmp_scalar(selection, array, scalar, dst, lt_scalar_dynamic)
}
...
pub unsafe fn le_scalar<T>(
    ...
    u64: AsPrimitive<<T::SimdType as IntrinsicSimdOrd>::BitMaskType>,
{
    cmp_scalar(selection, array, scalar, dst, le_scalar_dynamic)
}
